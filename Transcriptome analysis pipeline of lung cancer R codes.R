...
pdf("Results/PCA compairing RawData,Preprocessed data, and Batch corrected data.pdf",width = 10.5,height = 7)
...
pdf("Results/heatmap compairing RawData,Preprocessed data, and Batch corrected data.pdf",width=30,height = 30)
## Raw data
...
##### Box plot
pdf("Results/Boxplot compairing RawData,Preprocessed data, and Batch corrected data.pdf",width=30,height = 20)
